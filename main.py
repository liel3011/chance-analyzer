...
if df is not None:
    ...
    with tab_pairs:
        ...
        with sc1: s_choice1 = st.selectbox("S1", all_suits, index=0, label_visibility="collapsed") # Spade (index 0 now)
        with sc2: s_choice2 = st.selectbox("S2", all_suits, index=1, label_visibility="collapsed") # Heart (index 1 now)
        with sc3: 
